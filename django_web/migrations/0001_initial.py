# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2019-01-19 02:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(default=0, verbose_name='1:\u6267\u884c\u4e2d\uff0c2\uff1a\u7ed3\u675f\uff0c0\uff1a\u5f85\u6267\u884c')),
                ('startTime', models.DateTimeField(auto_now=True, verbose_name='\u5f00\u59cb\u65f6\u95f4')),
                ('endTime', models.DateTimeField(auto_now=True, verbose_name='\u7ed3\u675f\u65f6\u95f4')),
                ...
                ('CreateTime', models.DateTimeField(auto_now=True, verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('min', models.CharField(max_length=32, verbose_name='\u5206\u949f')),
                ('hour', models.CharField(max_length=32, verbose_name='\u5c0f\u65f6')),
                ('day', models.CharField(max_length=32, verbose_name='\u5929')),
                ('month', models.CharField(max_length=32, verbose_name='\u6708')),
                ('week', models.CharField(max_length=32, verbose_name='\u5468')),
            ],
        ),
        migrations.CreateModel(
            name='taskCase',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_web.Project', verbose_name='\u9879\u76ee'),
        ),
        migrations.AddField(
